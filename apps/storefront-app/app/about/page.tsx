      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="inline-block p-4 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl mb-4">
                <FontAwesomeIcon icon={faShieldAlt} className="w-8 h-8 text-blue-600" />
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="inline-block p-4 bg-gradient-to-br from-green-100 to-green-200 rounded-xl mb-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="inline-block p-4 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl mb-4">
                <FontAwesomeIcon icon={faHeart} className="w-8 h-8 text-purple-600" />
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="inline-block p-4 bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-200">
            <p className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mb-2">
              50K+
            </p>
            <p className="text-gray-600 font-semibold">Happy Customers</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-200">
            <p className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-teal-600 mb-2">
              10K+
            </p>
            <p className="text-gray-600 font-semibold">Products</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-200">
            <p className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 mb-2">
              500+
            </p>
            <p className="text-gray-600 font-semibold">Trusted Sellers</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-200">
            <p className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-red-600 mb-2">
              4.8/5
            </p>
