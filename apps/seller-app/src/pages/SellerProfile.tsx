...
import { Button, Badge, Spinner } from '@3asoftwares/ui';
import { authApi } from '../api/client';
import { storeAuth, getStoredAuth, Logger } from '@3asoftwares/utils/client';
...
export const SellerProfile: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-4 mx-auto">
      <h1 className="mt-2 text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8">
        Profile
      </h1>
        ...
        <div className="bg-gradient-to-r from-gray-600 via-gray-500 to-gray-700 px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 text-center sm:text-left">
            ...
            <div className="min-w-0">
              ...
              <p className="text-green-100 text-sm sm:text-base truncate">{user.email}</p>
            </div>
          </div>
        </div>
